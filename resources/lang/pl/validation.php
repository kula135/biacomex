...
return [
	...
	'regex' => 'Pole :attribute musi mieć format :format.',
	...
	'custom' => [
		'nip' => [
			'regex' => 'Pole nip musi mieć format xxx-xxx-xx-xx.',
		],
		'code' => [
			'regex' => 'Pole kod pocztowy musi mieć format xx-xxx.',
		],
	],
	/*
	  |--------------------------------------------------------------------------
